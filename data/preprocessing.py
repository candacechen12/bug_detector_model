...
DATA_FILE = "d4j_methods_sc_metrics_comments.csv"
BUG_FILE = "bugsjar_methods_sc_metrics_comments.csv"
...
def split_dataset():
    d4j = pd.read_csv(os.path.join(DATA_DIR, DATA_FILE))
    new_d4j = categorical_to_number_d4j(d4j)
    bugs_jar = pd.read_csv(os.path.join(DATA_DIR, BUG_FILE))
